...
import 'korean_lesson_detail_page.dart';
import 'korean_quiz_page.dart';

/// ================= PAGE =================
class KoreanQuizResultPage extends StatelessWidget {
  final int score;
  final int total;
  ...
  Stream<QuerySnapshot> top10Stream() {
        ...
        _outlineButton(
          ...
          onTap: () async {
            ...
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (_) =>
                    KoreanQuizPage(tests: tests, lessonDoc: lessonSnap),
              ),
            );
          },
        ),
        ...
        _outlineButton(
          ...
          onTap: () async {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (_) => KoreanLessonDetailPage(lessonDoc: doc),
              ),
            );
          },
        ),
