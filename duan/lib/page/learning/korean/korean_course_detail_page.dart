...
import 'korean_lesson_detail_page.dart'; // 👈 lesson tiếng Hàn
import 'package:firebase_auth/firebase_auth.dart';
// import 'quiz_page.dart';

class KoreanCourseDetailPage extends StatefulWidget {
  ...
  @override
  State<KoreanCourseDetailPage> createState() => _KoreanCourseDetailPageState();
}

class _KoreanCourseDetailPageState extends State<KoreanCourseDetailPage> {
                              ...
                              lessonButton(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => KoreanLessonDetailPage(
