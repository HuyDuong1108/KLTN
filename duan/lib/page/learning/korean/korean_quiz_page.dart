...
import 'korean_quiz_result_page.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class KoreanQuizPage extends StatefulWidget {
  final List tests;
  final DocumentSnapshot lessonDoc;
  final bool isReview;
  final Map<int, Map<String, dynamic>>? answers;

  const KoreanQuizPage({
    super.key,
    required this.tests,
  ...
  @override
  State<KoreanQuizPage> createState() => _KoreanQuizPageState();
}

class _KoreanQuizPageState extends State<KoreanQuizPage>
  ...
  void _showResult() async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => KoreanQuizResultPage(
          lessonRef: lessonRef,
          score: score,
          total: widget.tests.length,
