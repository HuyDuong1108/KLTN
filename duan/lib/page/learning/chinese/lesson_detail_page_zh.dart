...
class LessonDetailPageZh extends StatefulWidget {
  final DocumentSnapshot lessonDoc;
  final bool openReview;

  const LessonDetailPageZh({
    super.key,
  ...
  @override
  State<LessonDetailPageZh> createState() => _LessonDetailPageZhState();
}

class _LessonDetailPageZhState extends State<LessonDetailPageZh> {
...
//mới cập nhật: thêm index
  Widget _vocabCard(Map<String, dynamic> item, {required int index}) {
